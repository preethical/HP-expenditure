...
plot4 <- ggplot(data = medical_budget.long, aes(x= month,y=value,color = variable, group = 1))+ geom_line(size = 1)+ scale_y_continuous(labels = scales::comma)
...
barplot <- ggplot(subset(Sumpayment, District == "AMB"), aes(x="",y = Total, fill = SOE_description))+geom_bar(stat="identity", width = 1)
