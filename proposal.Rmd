...
```{r state_budget_data, echo=FALSE, fig.width=12, fig.height=12}
...
```{r district_data, echo = FALSE, fig.width=12, fig.height=12}
...
The above plot shows a district-wise distribution of hospitals plotted against public health expenditure for 2018-2019 (This size of the circles indicates the population of the district) 

- We can also look at the other endpoints such as health care workers in these centres. 

```{r health_care workers}
